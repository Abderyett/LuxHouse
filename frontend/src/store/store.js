...
const reducers = combineReducers({ porductList: productListReducer, productDetail: productDetailsReducer, cart: cartReducer, userLogin: loginReducer, registerUser: registerReducer });
